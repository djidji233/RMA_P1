...
class OtpusteniPatientAdapter(
    ...
    private val onDeleteContactClicked: (Patient) -> Unit) : ListAdapter<Patient, OtpusteniPatientViewHolder>(patientDiffItemCallback){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): OtpusteniPatientViewHolder {
        ...
        return OtpusteniPatientViewHolder(
            containerView,
            {
